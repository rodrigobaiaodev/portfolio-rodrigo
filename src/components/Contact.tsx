    ...
    <section id="contato" className="relative py-24 bg-black text-white font-sans border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-xl mx-auto mb-16">
          ...
          >
            <Send className="w-7 h-7 text-zinc-400" />
            {t('title')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-300 to-zinc-500">{t('titleHighlight')}</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div 
            ...
            className="group relative bg-zinc-950/50 backdrop-blur-md border border-zinc-800/80 hover:border-zinc-700 p-6 rounded-3xl transition-all duration-300 flex flex-col justify-between"
          >
            <div>
              <div className="w-12 h-12 bg-zinc-900 border border-zinc-800 rounded-2xl flex items-center justify-center text-zinc-300 mb-6 group-hover:scale-110 transition-transform">
